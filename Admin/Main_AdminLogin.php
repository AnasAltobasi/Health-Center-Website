...
if (isset($_POST['Submit'])) {
    ...
    if (empty($AdminName) || empty($Password)) {
        ...
        $query = " SELECT * FROM  loc_amdin WHERE Name='$AdminName'";
        ...
        if ($row = mysqli_fetch_assoc($result)) {
            ...
            if ($Password == $db_password) {
                header('Location: Main_Admin_Dash.php');
            } else {
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    ...
                    <li class="active"><a href="./Main_AdminLogin.php"><i class="fas fa-users-cog"></i>&nbsp;Main Admin Login</a></li>
                </ul>
            </nav>
        </div>
    </header>
                ...
                <center>
                    <form action="#" method="post" class="AdminLoginStyle mb-5">
                        ...
                        <div class="form-group text-left">
                            <label for="exampleInputEmail1">Main Admin Name</label>
