                        ...
                        <tbody>
                            ...
                            if ($result) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr><td>" . $row['ID'] . "</td><td>" . $row['Name'] . "</td><td>" . $row['Email'] . "</td><td>" . $row['Subject'] . "</td><td>" . $row['Message'] . "</td><td>" . "<a href=mailto:{$row["Email"]}><button type='button' class='btn btn-info' >Send Email</button></a>" . "</td></tr>";
                                }
                            }
                            ?>
                        </tbody>
